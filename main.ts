...
const mapper:any = {
  'gpt-3.5-turbo': Deno.env.get("DEPLOY_NAME_DEEPSEEK_R1"),
  'gpt-3.5-turbo-16k': Deno.env.get("DEPLOY_NAME_GPT4"),
  'gpt-4': Deno.env.get("DEPLOY_NAME_GPT4"),
  'gpt-4-32k': Deno.env.get("DEPLOY_NAME_GPT4"),
...
async function requestAzure(method: string, body: any, path: string, authKey?: string) {
  ...
  console.log("Fetch API URL:", fetchAPI);
